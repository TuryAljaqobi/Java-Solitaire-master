...
/*
Creating the system for the piles
Each pile corresponds to a specific suit
If pile is empty, you can only place an Ace
If not empty, you must place card that is 1 higher than top card in pile
*/
